...
CREATE TABLE contribute (favourite_category VARCHAR(100) NOT NULL,
                            books_propositions VARCHAR(100) NOT NULL )




INSERT INTO books VALUES ('40' , 'Ahmed Shugeiri' , 'dispo', 2584 ,'AL' , 'Biographie', date(now()) ) ;
INSERT INTO books VALUES ('The Making of a Navy SEAL' , 'Brandon Webb ' , 'dispo', 7159 ,'DO' , 'Biographie', date(now())) ;
INSERT INTO books VALUES ('une chambre à soi' , 'Virginia Woolf ' , 'non disponible', 2486 ,'JB' , 'Fiction' , date(now())) ;


--postgress
INSERT INTO books VALUES ('40' , 'Ahmed Shugeiri' , 'dispo', 2584 , 5, 'Biographie') ;
INSERT INTO books VALUES ('The Making of a Navy SEAL' , 'Brandon Webb ' , 'dispo', 7159 ,6 , 'Biographie') ;
INSERT INTO books VALUES ('une chambre à soi' , 'Virginia Woolf ' , 'non disponible', 2486 ,3 , 'Fiction') ;
INSERT INTO books VALUES ('Antigone' , 'Jean Anouilh ' , 'dispo', 1782 ,4 , 'Tragédie') ;
INSERT INTO books VALUES ('The Feynman Lectures on Physics' , 'Richard Feynman' , 'non disponible', 1467 ,20 , 'Scientifique') ;
INSERT INTO books VALUES ('Cosmos' , 'Carl Sagan' , 'non disponible', 1466 ,10 , 'Scientifique') ;
