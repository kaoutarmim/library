    ...
    if choice =='Sign In'  :
        ...
        if st.sidebar.checkbox("Login") :
            ...
            if result:
                ...
                X=st.sidebar.selectbox('MENU',["Menu","View booklist","View Infos and Feedbacks", "Add Book","Remove a book","Lend a book","Return a book","Search Books",'SHOW STATISTICS', 'contribute','Student propositions'])
                options (st,X,ID)
            else :
    ...
    if X=='Student propositions':
        with connection.cursor() as cursor:
            ...
            if st.checkbox("needs categories"):
                st.sidebar.write('most needed categories are:')
